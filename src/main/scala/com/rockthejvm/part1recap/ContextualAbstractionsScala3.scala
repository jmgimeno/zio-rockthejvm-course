...
object ContextualAbstractionsScala3 {
  ...
  def aHundred = multiply(10) // defaultAmount is passed automatically
  ...
  val sum10 = combineAll(numbers) // intCombiner passes automatically
  // combineAll(List("Cats", "Scala")) // does not compile
  ...
  val someOptions: Option[Int] = combineAll(List(Some(1), None, Some(2)))
  ...
  val som10_vs = numbers.reduceAll
